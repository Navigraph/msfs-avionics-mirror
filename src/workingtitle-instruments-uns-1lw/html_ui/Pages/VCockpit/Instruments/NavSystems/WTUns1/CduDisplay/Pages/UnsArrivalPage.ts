...
class UnsArrivalPageController {
  ...
  /**
   * Updates the store from the active flight plan, used when the page is resumed.
   */
  public updateStore(): void {
    const plan = this.fms.getFlightPlan(UnsFlightPlans.Active);
    this.updateStoreFromFlightPlan(plan);
  }
