import {
  ...
  APGSDirector, APHdgDirector, APHdgHoldDirector, APLateralModes, APLvlDirector, APNavDirector, APPitchDirector, APRollDirector, APTrkDirector,
  APTrkHoldDirector, APValues, APVerticalModes, APVSDirector, EventBus, MathUtils, NavMath, UnitType
...
export class UnsAPConfig implements APConfig {
  ...
  /** @inheritdoc */
  public createHeadingHoldDirector(apValues: APValues): APHdgHoldDirector {
  ...
  /** @inheritdoc */
  public createTrackHoldDirector(apValues: APValues): APTrkHoldDirector {
  ...
  public createGpssDirector(apValues: APValues): APGpsSteerDirector {
    return new APGpsSteerDirector(
        ...
        {
          maxBankAngle: this.getNavModeMaxBank,
        },
    );
  }
