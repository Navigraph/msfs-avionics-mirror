...
class UnsNavPageStore {
  ...
  public readonly lnavMode = ConsumerSubject.create(this.bus.getSubscriber<UnsLnavSteeringStateEvents>().on('mode'), null);

  public readonly commandedHeading = ConsumerSubject.create(this.bus.getSubscriber<UnsLnavSteeringStateEvents>().on('commandedHeading').whenChanged(), null);

  public readonly commandedTurnDirection = ConsumerSubject.create(this.bus.getSubscriber<UnsLnavSteeringStateEvents>().on('commandedTurnDirection').whenChanged(), null);
