...
class UnsLNavDebugPageStore {
  ...
  public readonly lnavValid = ConsumerSubject.create(
    this.bus.getSubscriber<UnsLnavSteeringStateEvents>().on('isValid'),
    false,
  );

  public readonly lnavMode = ConsumerSubject.create(
    this.bus.getSubscriber<UnsLnavSteeringStateEvents>().on('mode'),
    UnsLnavMode.FlightPlanTracking,
  );

  public readonly lnavCommandedHeading = ConsumerSubject.create(
    this.bus.getSubscriber<UnsLnavSteeringStateEvents>().on('commandedHeading'),
    NaN,
  );

  public readonly lnavCommandedTurnDirection = ConsumerSubject.create(
    this.bus.getSubscriber<UnsLnavSteeringStateEvents>().on('commandedTurnDirection'),
    null,
  );

  public readonly lnavXtk = ConsumerSubject.create(
    this.bus.getSubscriber<UnsLnavSteeringStateEvents>().on('xtk'),
    NaN,
  );

  public readonly lnavPhi = ConsumerSubject.create(
    this.bus.getSubscriber<UnsLnavSteeringStateEvents>().on('desiredBankAngle'),
    NaN,
  );

  public readonly lnavTae = ConsumerSubject.create(
    this.bus.getSubscriber<UnsLnavSteeringStateEvents>().on('tae'),
    NaN,
  );

  public readonly lnavDtk = ConsumerSubject.create(
    this.bus.getSubscriber<UnsLnavSteeringStateEvents>().on('dtk'),
    NaN,
  );
