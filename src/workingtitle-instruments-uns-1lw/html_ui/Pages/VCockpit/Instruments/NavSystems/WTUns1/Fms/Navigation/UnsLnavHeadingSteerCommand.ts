import { Accessible, APGpsSteerDirectorSteerCommand, LerpLookupTable, MathUtils, NavMath, Subscribable } from '@microsoft/msfs-sdk';

/**
 * UNS LNAV commanded heading mode steer command
 */
export class UnsLnavHeadingSteerCommand implements Accessible<Readonly<APGpsSteerDirectorSteerCommand>> {
  ...
  private readonly command: APGpsSteerDirectorSteerCommand = {
    isValid: false,
    desiredBankAngle: 0,
    dtk: 0,
    xtk: 0,
