...
/**
 * A readonly version of {@link GeoCircle}.
 */
export type ReadonlyGeoCircle = Omit<GeoCircle, 'set' | 'setAsGreatCircle' | 'reverse' | 'rotate'>;
...
export class GeoCircle {
  ...
  public isValid(): boolean {
    return Vec3Math.isFinite(this._center) && isFinite(this.radius);
  }
   ...
   */
  public set(center: ReadonlyFloat64Array | Readonly<LatLonInterface>, radius: number): this {
    if (center instanceof Float64Array) {
      ...
      GeoPoint.sphericalToCartesian(center as Readonly<LatLonInterface>, this._center);
    }
  ...
  private _setRadius(radius: number): this {
    (this.radius as number) = Math.abs(radius) % Math.PI;
    this._sinRadius = Math.sin(this.radius);
    return this;
  }
   ...
   * @returns This circle, after it has been changed.
   */
  public setAsGreatCircle(point1: ReadonlyFloat64Array | Readonly<LatLonInterface>, point2: ReadonlyFloat64Array | Readonly<LatLonInterface>): this;
  /**
   ...
   * @returns This circle, after it has been changed.
   */
  public setAsGreatCircle(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, bearing: number): this;
  /**
   ...
   * @returns This circle, after it has been changed.
   */
  public setAsGreatCircle(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, circle: ReadonlyGeoCircle): this;
  // eslint-disable-next-line jsdoc/require-jsdoc
  public setAsGreatCircle(
    arg1: ReadonlyFloat64Array | Readonly<LatLonInterface>,
    arg2: ReadonlyFloat64Array | Readonly<LatLonInterface> | number | ReadonlyGeoCircle
  ): this {
    // CACHE USE:
    // vec3: indexes 0, 1
    // geoPoint: indexes 0
  ...
  public reverse(): this {
    ...
    (this.radius as number) = Math.PI - this.radius;
    return this;
  }
   ...
   */
  private distanceToCenter(point: ReadonlyFloat64Array | Readonly<LatLonInterface>): number {
    // CACHE USE:
    // vec3: indexes 0
    ...
    if (point instanceof Float64Array) {
      ...
      point = GeoPoint.sphericalToCartesian(point as Readonly<LatLonInterface>, GeoCircle.vec3Cache[0]);
    }
   ...
   * @param out A 3D vector to which to write the result. The result will be written as the cartesian (x, y, z)
   * representation, in units of great-arc radians.
   * @returns The closest point on this circle to the specified point.
   */
  public closest(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, out: Float64Array): Float64Array;
  /**
   * Finds the closest point on this circle to a specified point. In other words, projects the specified point onto
   * this circle. If the specified point is equidistant from all points on this circle (i.e. it is coincident with or
   ...
   * @returns The closest point on this circle to the specified point.
   */
  public closest(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, out: GeoPoint): GeoPoint;
  /**
   * Finds the closest point on this circle to a specified point. In other words, projects the specified point onto
   * this circle. If the specified point is equidistant from all points on this circle (i.e. it is coincident with or
   * antipodal to this circle's center), NaN will be written to all components of the result.
   * @param point A point, represented as either a position vector or lat/long coordinates.
   * @param out A 3D vector or GeoPoint object to which to write the result. If a vector is supplied, then the result
   * will be written as the cartesian (x, y, z) representation, in units of great-arc radians.
   * @returns The closest point on this circle to the specified point.
   */
  public closest<Out extends Float64Array | GeoPoint>(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, out: Out): Out;
  // eslint-disable-next-line jsdoc/require-jsdoc
  public closest(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, out: Float64Array | GeoPoint): Float64Array | GeoPoint {
    // CACHE USE:
    // vec3: indexes 0, 1, 2
    ...
    const offset = Vec3Math.multScalar(this._center, Math.cos(this.radius), GeoCircle.vec3Cache[1]);
   ...
   */
  public distance(point: ReadonlyFloat64Array | Readonly<LatLonInterface>): number {
   ...
   */
  public includes(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, tolerance = GeoCircle.ANGULAR_TOLERANCE): boolean {
   ...
   */
  public encircles(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, inclusive = true, tolerance = GeoCircle.ANGULAR_TOLERANCE): boolean {
    const distance = this.distance(point);
    return inclusive
      ? distance <= tolerance
      : distance < -tolerance;
   ...
   */
  public angleAlong(
    start: ReadonlyFloat64Array | Readonly<LatLonInterface>,
    end: ReadonlyFloat64Array | Readonly<LatLonInterface>,
    tolerance = GeoCircle.ANGULAR_TOLERANCE,
    equalityTolerance = 0
  ): number {
    // CACHE USE:
    // vec3: indexes 0, 1, 2, 3, 4

    if (!(start instanceof Float64Array)) {
      start = GeoPoint.sphericalToCartesian(start as Readonly<LatLonInterface>, GeoCircle.vec3Cache[1]);
    }
    if (!(end instanceof Float64Array)) {
      end = GeoPoint.sphericalToCartesian(end as Readonly<LatLonInterface>, GeoCircle.vec3Cache[2]);
    }
    ...
    if (this.radius <= GeoCircle.ANGULAR_TOLERANCE) {
      return 0;
    }
   ...
   */
  public bearingAt(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, tolerance = GeoCircle.ANGULAR_TOLERANCE): number {
    // CACHE USE:
    // vec3: indexes 0, 1, 2, 3

    if (!(point instanceof Float64Array)) {
      point = GeoPoint.sphericalToCartesian(point as Readonly<LatLonInterface>, GeoCircle.vec3Cache[1]);
    }
   ...
   * @throws Error if the point does not lie on this circle.
   */
  public offsetDistanceAlong(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, distance: number, out: Float64Array, tolerance?: number): Float64Array;
  /**
   * Offsets a point on this circle by a specified distance. The direction of the offset for positive distances is
   * counterclockwise when viewed from above the center of this circle.
   * @param point The point to offset.
   ...
   * @throws Error if the point does not lie on this circle.
   */
  public offsetDistanceAlong(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, distance: number, out: GeoPoint, tolerance?: number): GeoPoint;
  /**
   * Offsets a point on this circle by a specified distance. The direction of the offset for positive distances is
   * counterclockwise when viewed from above the center of this circle.
   * @param point The point to offset.
   ...
   * @throws Error if the point does not lie on this circle.
   */
  public offsetDistanceAlong<Out extends Float64Array | GeoPoint>(
    point: ReadonlyFloat64Array | Readonly<LatLonInterface>,
    distance: number,
    out: Out,
    tolerance?: number
  ): Out;
   ...
   * @throws Error if the point does not lie on this circle.
   */
  public offsetAngleAlong(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, angle: number, out: Float64Array, tolerance?: number): Float64Array;
  /**
   * Offsets a point on this circle by a specified angular distance. The direction of the offset for positive distances
   * is counterclockwise when viewed from above the center of this circle.
   * @param point The point to offset.
   ...
   * @throws Error if the point does not lie on this circle.
   */
  public offsetAngleAlong(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, angle: number, out: GeoPoint, tolerance?: number): GeoPoint;
  /**
   * Offsets a point on this circle by a specified angular distance. The direction of the offset for positive distances
   * is counterclockwise when viewed from above the center of this circle.
   * @param point The point to offset.
   ...
   * @throws Error if the point does not lie on this circle.
   */
  public offsetAngleAlong<Out extends Float64Array | GeoPoint>(
    point: ReadonlyFloat64Array | Readonly<LatLonInterface>,
    angle: number,
    out: Out,
    tolerance?: number
  ...
  private _offsetAngleAlong(
    ...
    if (!(point instanceof Float64Array)) {
      point = GeoPoint.sphericalToCartesian(point as Readonly<LatLonInterface>, GeoCircle.vec3Cache[3]);
    }
    ...
    // To offset a point along this circle is equivalent to rotating the point's position vector about an axis defined
    // by this circle's center vector. Since we are naturally given an axis-angle representation for the rotation, we
    // will use quaternion rotation to calculate the rotated vector.

    // 2 * sin(angle / 2) * cos(angle / 2) = sin(angle)
    const a = Math.sin(angle);
    // 2 * (sin(angle / 2)) ^ 2 = 1 - cos(angle)
    const b = 1 - Math.cos(angle);

    const cross = Vec3Math.cross(this._center, point, GeoCircle.vec3Cache[0]);
    const crossCross = Vec3Math.cross(this._center, cross, GeoCircle.vec3Cache[1]);

    const rotX = point[0] + a * cross[0] + b * crossCross[0];
    const rotY = point[1] + a * cross[1] + b * crossCross[1];
    const rotZ = point[2] + a * cross[2] + b * crossCross[2];
   ...
   */
  public rotate(
    pivot: ReadonlyFloat64Array | Readonly<LatLonInterface>,
    angle: number,
    tolerance = GeoCircle.ANGULAR_TOLERANCE
  ): GeoCircle {
    // CACHE USE:
    ...
    if (!(pivot instanceof Float64Array)) {
      pivot = GeoPoint.sphericalToCartesian(pivot as Readonly<LatLonInterface>, GeoCircle.vec3Cache[0]);
    }
    ...
    this._offsetAngleAlong(center, -angle, this._center, Math.PI);
    return this;
  }
   ...
   * @param tolerance The error tolerance of this operation, in great-arc radians. Defaults to `0`.
   * @returns The number of solutions written to the out array. Either 0, 1, or 2.
   */
  public intersection(other: ReadonlyGeoCircle, out: Float64Array[], tolerance = 0): number {
    // CACHE USE:
    // vec3: indexes 0, 1, 2
    ...
    const cross = Vec3Math.cross(center1, center2, GeoCircle.vec3Cache[0]);
    ...
    const intersection = Vec3Math.add(
      Vec3Math.multScalar(center1, a, GeoCircle.vec3Cache[1]),
      Vec3Math.multScalar(center2, b, GeoCircle.vec3Cache[2]),
    ...
    const sinTolSquared = sinTol * sinTol;

    const offsetSquared = (1 - intersectionLengthSquared) / crossLengthSquared;

    if (offsetSquared < -sinTolSquared) {
      return 0;
    } else if (offsetSquared <= sinTolSquared) {
      if (intersectionLengthSquared !== 1) {
        Vec3Math.normalize(intersection, intersection);
      }

      if (!out[0]) {
        out[0] = new Float64Array(3);
      }
      out[0].set(intersection);
   ...
   * @returns The number of solutions written to the out array. Either 0, 1, or 2.
   */
  public intersectionGeoPoint(other: ReadonlyGeoCircle, out: GeoPoint[], tolerance = 0): number {
    // CACHE USE:
    // vec3: indexes 0, 1, 2
    // intersection

    const solutionCount = this.intersection(other, GeoCircle.intersectionCache, tolerance);
   ...
   * @param other The other circle to test for intersections.
   * @param tolerance The error tolerance of this operation, in great-arc radians. Defaults to
   * `GeoCircle.ANGULAR_TOLERANCE` if not specified.
   * @returns The number of intersection points between this circle and the other one.
   */
  public numIntersectionPoints(other: ReadonlyGeoCircle, tolerance = GeoCircle.ANGULAR_TOLERANCE): number {
    // CACHE USE:
    // vec3: indexes 0, 1
    ...
    const offset = (1 - intersectionLengthSquared) / crossLengthSquared;

    const sinTol = Math.sin(tolerance);
    const sinTolSquared = sinTol * sinTol;

    if (offset < -sinTolSquared) {
      return 0;
    } else if (offset > sinTolSquared) {
      return 2;
    } else {
      return 1;
    }
   ...
   */
  public static createFromPoint(point: Readonly<LatLonInterface>, radius: number): GeoCircle {
   ...
   * the second point.
   */
  public static createGreatCircle(point1: ReadonlyFloat64Array | Readonly<LatLonInterface>, point2: ReadonlyFloat64Array | Readonly<LatLonInterface>): GeoCircle;
  /**
   ...
   * the same point.
   */
  public static createGreatCircle(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, bearing: number): GeoCircle;
  /**
   ...
   */
  public static createGreatCircle(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, circle: ReadonlyGeoCircle): GeoCircle;
  // eslint-disable-next-line jsdoc/require-jsdoc
   ...
   */
  public static createGreatCircleFromPointBearing(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, bearing: number): GeoCircle {
  ...
  public static getGreatCircleNormal(
    point1: ReadonlyFloat64Array | Readonly<LatLonInterface>,
    point2: ReadonlyFloat64Array | Readonly<LatLonInterface>,
    out: Float64Array
  ): Float64Array;
  /**
   ...
   */
  public static getGreatCircleNormal(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, bearing: number, out: Float64Array): Float64Array;
  /**
   ...
   * specified point.
   */
  public static getGreatCircleNormal(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, circle: ReadonlyGeoCircle, out: Float64Array): Float64Array;
  // eslint-disable-next-line jsdoc/require-jsdoc
  public static getGreatCircleNormal(
    arg1: ReadonlyFloat64Array | Readonly<LatLonInterface>,
    arg2: ReadonlyFloat64Array | Readonly<LatLonInterface> | number | ReadonlyGeoCircle,
  ...
  private static _getGreatCircleNormal(
    ...
    if (typeof arg2 === 'number') {
      ...
      return GeoCircle.getGreatCircleNormalFromPoints(arg1, arg2 as ReadonlyFloat64Array | Readonly<LatLonInterface>, out);
    }
  }
  ...
  private static getGreatCircleNormalFromPoints(
    ...
    if (!(point1 instanceof Float64Array)) {
      point1 = GeoPoint.sphericalToCartesian(point1 as Readonly<LatLonInterface>, GeoCircle.vec3Cache[0]);
    }
    if (!(point2 instanceof Float64Array)) {
      point2 = GeoPoint.sphericalToCartesian(point2 as Readonly<LatLonInterface>, GeoCircle.vec3Cache[1]);
    }
   ...
   * bearing at that point.
   */
  private static getGreatCircleNormalFromPointBearing(point: ReadonlyFloat64Array | Readonly<LatLonInterface>, bearing: number, out: Float64Array): Float64Array {
    // CACHE USE:
    // geoPoint: indexes 0
    ...
    const lat = (point as Readonly<LatLonInterface>).lat * Avionics.Utils.DEG2RAD;
    const long = (point as Readonly<LatLonInterface>).lon * Avionics.Utils.DEG2RAD;
   ...
   * specified point.
   */
  private static getGreatCircleNormalFromCircle(
    point: ReadonlyFloat64Array | Readonly<LatLonInterface>,
