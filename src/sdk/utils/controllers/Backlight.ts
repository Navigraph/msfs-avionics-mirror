import { AstroMath } from '../../astro/AstroMath';
 ...
 * @deprecated It is now recommended to use the `AMBIENT LIGHT SENSOR` SimVar to implement automatic backlighting.
 */
export class BacklightLevelController {
  ...
  private updateAutoBacklightIntensity(simTime: number): void {
    ...
    const solarZenithAngle = AstroMath.getSolarZenithAngle(this.ppos, simTime);
