import {
  ArrayUtils, BingComponent, ColorUtils, ConsumerSubject, ConsumerValue, MapSystemContext, MapSystemController, MapSystemKeys, MapTerrainColorsModule,
  MathUtils, ReadonlyFloat64Array, Vec2Math
...
export class MapTerrainColorsController extends MapSystemController<MapTerrainColorsControllerModules> {
  ...
  private readonly terrainWeatherStateModule = this.context.model.getModule(MapKeys.TerrainWeatherState);
  ...
  private readonly gpwsOperatingMode = ConsumerSubject.create(null, 'Off');
  ...
  /**
   * Creates an instance of MapTerrainColorsController.
  ...
  public onAfterMapRender(): void {
    ...
    this.mapDataProvider.landDetailLevel.sub((v) => {
      switch (v) {
        case MapDeclutterMode.None:
          this.terrainColorsModule.colors.set(MapTerrainColorsController.BLANK_TERRAIN_COLORS);
          break;
        case MapDeclutterMode.Level1:
          this.terrainColorsModule.colors.set(MapTerrainColorsController.SA_TERRAIN_COLORS);
          break;
        case MapDeclutterMode.Level2:
          this.terrainColorsModule.colors.set(MapTerrainColorsController.GEO_TERRAIN_COLLORS);
          break;
        case MapDeclutterMode.Level3:
          this.terrainColorsModule.colors.set(MapTerrainColorsController.GEO_TERRAIN_COLLORS);
          break;
        default:
          break;
