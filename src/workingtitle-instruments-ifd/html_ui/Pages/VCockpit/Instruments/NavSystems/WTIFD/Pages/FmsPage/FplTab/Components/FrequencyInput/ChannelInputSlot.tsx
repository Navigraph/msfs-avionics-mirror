import { ComponentProps, FSComponent, LifecycleComponent, MutableSubscribable, Subject, Subscribable, VNode } from '@microsoft/msfs-sdk';
 ...
 */
export class ChannelInputSlot extends LifecycleComponent<ChannelInputSlotProps> {
  ...
  public onAfterRender(node: VNode): void {
    ...
    this.slotRef.instance.characters.sub(() => {
      const channel = this.slotRef.instance.value.get();
      const freq = this.freqArray[channel] ?? 0;
