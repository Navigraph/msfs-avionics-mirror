import { APLateralModes, APModeType, APStateManager, APVerticalModes, KeyEventData, KeyEventManager } from '@microsoft/msfs-sdk';

/**
 * A state manager for the IFD autopilot.
 */
export class IfdAPStateManager extends APStateManager {
  /** @inheritDoc */
   ...
   */
  public disengageAutopilot(): void {
