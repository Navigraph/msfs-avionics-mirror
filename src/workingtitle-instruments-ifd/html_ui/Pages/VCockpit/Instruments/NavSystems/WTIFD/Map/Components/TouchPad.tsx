import {
  ComponentProps, DisplayComponent, Easing, EventBus, FSComponent, InstrumentEvents, ReadonlyFloat64Array, SetSubject, Subscribable, SubscribableSet,
...
export interface TouchPadProps extends ComponentProps {
  ...
  /**
   * A function which is called when the user double clicks quickly
   * @param position The current position of the mouse.
   ...
   * @param pad The pad.
   */
  onDoubleTapped?: <T extends TouchPad = TouchPad>(
