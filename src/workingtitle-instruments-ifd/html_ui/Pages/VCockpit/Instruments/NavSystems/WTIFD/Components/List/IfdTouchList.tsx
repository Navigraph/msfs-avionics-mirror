...
import './IfdTouchList.css';

/**
 * Component props for IfdTouchList.
 */
export interface IfdTouchListProps extends ScrollListProps {
  /**
 ...
 */
export class IfdTouchList extends ScrollList<IfdTouchListProps> {
  ...
  protected getReservedCssClasses(): readonly string[] {
    return IfdTouchList.RESERVED_CLASSES;
  }
