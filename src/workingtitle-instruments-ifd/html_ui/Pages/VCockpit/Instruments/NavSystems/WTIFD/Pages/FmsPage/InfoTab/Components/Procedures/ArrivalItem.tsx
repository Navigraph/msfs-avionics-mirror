...
/** Interface for Arrival list data. */
export interface ArrivalListData extends DynamicListData {
...
/** The properties for the {@link ArrivalItem} component. */
interface ArrivalItemProps extends ComponentProps {
  ...
  readonly procedureListData: ArrivalListData;
   ...
   * 0 = Chevron, 1 = Enroute, 2 = Runway
   */
  readonly expandedFocusIndex: Subscribable<number>;
}

/**
 * The Arrival info item of the info tab.
 */
export class ArrivalItem extends LifecycleComponent<ArrivalItemProps> {
   ...
   * 0 = Chevron (collapse), 1 = Enroute menu, 2 = Runway menu.
   *
    ...
    return (
      ...
      >
        <div class="header" ref={this.headerRef}>
          <div class="name">
            {/* Expanded header: transition.procedure.runway */}
        ...
        <div class={{ 'procedure-preview': true, hidden: this.isCollapsed }}>
          <MapContainer
            ...
            previewMode={true}
            fms={this.props.fms}
            class="arrival-item-map-container"
          />
        </div>
      </InfoItem>
    );
