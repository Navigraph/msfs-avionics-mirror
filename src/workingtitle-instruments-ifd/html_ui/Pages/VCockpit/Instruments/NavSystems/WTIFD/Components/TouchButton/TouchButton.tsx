import {
  ClassProp, ComponentProps, DisplayComponent, FSComponent, SetSubject, Subscribable, SubscribableMapFunctions, SubscribableUtils, Subscription, VNode
...
export class TouchButton<P extends TouchButtonProps = TouchButtonProps> extends DisplayComponent<P> {
  ...
  public render(): VNode {
    ...
    if (typeof this.props.class === 'object') {
      this.cssClassSub = FSComponent.bindSetToCssClasses(this.cssClassSet, reservedClasses, this.props.class);
