...
import { Fms } from './Fms';
import { IfdFlightPlanRouteProvider as IfdFlightPlanRouteProvider } from './IfdFlightPlanRouteProvider';
 ...
 * {@link Fms}.
 */
export class IfdPrimaryFlightPlanRouteProvider implements IfdFlightPlanRouteProvider {
  /**
   * Creates a new instance of IfdPrimaryFlightPlanRouteProvider.
  ...
  public async getRoute(): Promise<ReadonlyFlightPlanRoute> {
    try {
      if (this.fms.hasPrimaryFlightPlan()) {
        return IfdFlightPlanRouteUtils.createRouteFromFlightPlan(
          this.fms.facLoader,
