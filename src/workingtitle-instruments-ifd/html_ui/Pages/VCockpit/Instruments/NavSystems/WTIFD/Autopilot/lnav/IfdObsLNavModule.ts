...
/**
 * Options for {@link IfdObsLNavModule}.
 */
export type IfdObsLNavModuleOptions = {
  /**
 ...
 */
export class IfdObsLNavModule implements LNavOverrideModule {
  ...
  /**
   * Creates a new instance of IfdObsLNavModule.
  ...
  public constructor(
    ...
    options?: Readonly<IfdObsLNavModuleOptions>
  ) {
    if (!LNavUtils.isValidLNavIndex(index)) {
      throw new Error(`IfdObsLNavModule: invalid index (${index}) specified (must be a non-negative integer).`);
    }
