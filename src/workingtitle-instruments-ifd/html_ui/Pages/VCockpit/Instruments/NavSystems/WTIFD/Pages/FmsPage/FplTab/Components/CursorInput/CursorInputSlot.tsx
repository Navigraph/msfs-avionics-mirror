import {
  ComponentProps, DisplayComponent, FSComponent, MappedSubject, MutableSubscribable, SetSubject, Subject, Subscribable, SubscribableSet,
...
export class GenericCursorInputSlot<T, P extends GenericCursorInputSlotProps<T> = GenericCursorInputSlotProps<T>>
  ...
  /**
   * Check if all the characters in the slot are currently empty (null)
   * @returns boolean
   */
  public charsEmpty(): boolean {
    return this.characterArray.every(character => character.get() === null);
  }
