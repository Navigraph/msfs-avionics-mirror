...
/**
 * An information display for a GTC waypoint information page. Displays a waypoint's city, region, and location, and
 * the distance/bearing to the waypoint.
 * @deprecated This component has been replaced by `GtcWaypointInfoInfo`.
 */
