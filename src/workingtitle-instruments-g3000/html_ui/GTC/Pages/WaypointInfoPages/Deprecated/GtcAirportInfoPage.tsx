 ...
 * @deprecated This component has been replaced by `GtcAirportInfoPage2`.
 */
    ...
    return (
      <>
        <div class='airport-info-page-tab airport-info-page-freq'>
          ...
          <div
            class={{
              'airport-info-page-tab-list-none': true,
              'airport-info-page-freq-none': true,
      ...
      <>
        <div class='airport-info-page-tab airport-info-page-weather'>
          ...
          <div
            class={{
              'airport-info-page-tab-list-none': true,
              'airport-info-page-weather-none': true,
      ...
      <>
        <div class='airport-info-page-tab airport-info-page-runways'>
          ...
          <div
            class={{
              'airport-info-page-tab-list-none': true,
              'airport-info-page-runways-none': true,
        ...
        <GtcWaypointInfoPageNoWaypointMessage ref={this.noWaypointRef} selectedWaypoint={this.props.waypoint}>
          No Airport Available
        </GtcWaypointInfoPageNoWaypointMessage>
      </>
    );
      ...
      <>
        <div class='airport-info-page-tab airport-info-page-proc'>
          ...
          <div
            class={{
              'airport-info-page-tab-list-none': true,
              'airport-info-page-proc-none': true,
