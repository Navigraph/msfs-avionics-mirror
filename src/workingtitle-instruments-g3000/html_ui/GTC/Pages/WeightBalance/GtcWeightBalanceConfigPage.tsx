import {
  ArraySubject, FSComponent, NumberFormatter, NumberUnitSubject, Subject, Subscribable, Subscription, Unit, UnitFamily,
  UnitType, VNode
...
import {
  ControllableDisplayPaneIndex, NumberUnitDisplay, WeightBalanceConfig, WeightBalanceLoadStationDef,
  WeightBalanceUserSettingManager, WeightFuelUserSettings
...
export class GtcWeightBalanceConfigPage extends GtcView<GtcWeightBalanceConfigPageProps> {
  ...
  private readonly subscriptions: Subscription[] = this.basicEmptyMacValueText
    ? [this.armUnit, this.basicEmptyMacValueText]
    : [this.armUnit];
