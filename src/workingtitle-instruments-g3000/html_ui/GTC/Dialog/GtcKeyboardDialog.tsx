...
import { G3000FilePaths, G3000WaypointSearchType } from '@microsoft/msfs-wtg3000-common';
      ...
      <div ref={this.keyboardDialogRef} class="keyboard-dialog">
        ...
        <div class="keyboard keyboard-alpha">
          <div class="row">
            ...
            >
              <img class="find-icon" src={`${G3000FilePaths.ASSETS_PATH}/Images/GTC/icon_find.png`} />
