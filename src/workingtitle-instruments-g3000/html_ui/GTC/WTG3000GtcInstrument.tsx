...
import {
  CasSystem, ClockEvents, FacilityWaypoint, FSComponent, IntersectionFacility, NdbFacility,
...
import {
  AvionicsConfig, AvionicsStatus, AvionicsStatusChangeEvent, DefaultFmsSpeedTargetDataProvider,
  ExistingUserWaypointsArray, FlightPlanListManager, FlightPlanStore, G3000FilePaths, G3000NearestContext, G3000Plugin,
...
import {
  ...
  GtcLoadFrequencyDialog, GtcLocalTimeOffsetDialog, GtcMessageDialog, GtcMinimumsSourceDialog, GtcMinuteDurationDialog, GtcMomentArmDialog, GtcRunwayLengthDialog,
