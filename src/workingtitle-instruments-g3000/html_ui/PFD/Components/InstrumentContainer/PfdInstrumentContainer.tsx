...
import {
  AltimeterDataProvider, DateTimeUserSettings, DefaultAoaDataProvider, DefaultMarkerBeaconDataProvider,
...
import {
  ...
  G3000FullCASDisplay, G3000FullCASDisplay2, G3000NavIndicators, G3000NavInfoNavIndicator, IauUserSettingManager,
  MapUserSettings, PfdAliasedUserSettingTypes, PfdMapLayoutSettingMode, SoftKeyHEventMap, VSpeedUserSettingManager
    ...
    return (
      <div class={this.rootCssClass}>
        ...
        {this.props.instrumentConfig.cas.casEnabled && (
          this.props.instrumentConfig.cas.version === 2
            ? (
