 ...
 * @deprecated This class is no longer supported. Please use G3000CASDisplay2 instead.
 */
 ...
 * @deprecated This class is no longer supported. Please use G3000CASMessageCount2 instead.
 */
 ...
 * @deprecated This class is no longer supported. Please use G3000FullCASDisplay2 instead.
 */
export class G3000FullCASDisplay extends DisplayComponent<G3000FullCASDisplayProps> {
  ...
  public render(): VNode {
    return (
      <div ref={this.divRef} class='cas-container' data-checklist={this.props.dataChecklist ?? ''}>
        <G3000CASDisplay
          bus={this.props.bus}
