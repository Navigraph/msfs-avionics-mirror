...
/**
 * Component props for {@link G3000CASMessageCount2}.
 */
export interface G3000CASMessageCount2Props {
 ...
 */
export class G3000CASMessageCount2 extends DisplayComponent<G3000CASMessageCount2Props> {
  ...
  private onHighestPriorityChanged(priority: AnnunciationType | null): void {
    switch (priority) {
      case AnnunciationType.Warning:
        this.labelRef.instance.classList.remove('cas-message-count-2-label-caution');
        this.labelRef.instance.classList.add('cas-message-count-2-label-warning');
        break;
      case AnnunciationType.Caution:
        this.labelRef.instance.classList.remove('cas-message-count-2-label-warning');
        this.labelRef.instance.classList.add('cas-message-count-2-label-caution');
        break;
      default:
        this.labelRef.instance.classList.remove('cas-message-count-2-label-warning');
        this.labelRef.instance.classList.remove('cas-message-count-2-label-caution');
  ...
  public render(): VNode {
    return (
      <div class='cas-message-count-2'>
        <div ref={this.labelRef} class='cas-message-count-2-label'>CAS</div>
        <div class='cas-message-count-2-count cas-message-count-2-count-above'>
          <span>{this.messageAboveCountText}</span><span class='cas-message-count-2-count-arrow'>↑</span>
        </div>
        <div class='cas-message-count-2-count cas-message-count-2-count-below'>
          <span>{this.messageBelowCountText}</span><span class='cas-message-count-2-count-arrow'>↓</span>
        </div>
      </div>
    );
  }
