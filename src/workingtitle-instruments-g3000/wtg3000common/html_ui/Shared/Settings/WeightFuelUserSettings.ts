...
export type WeightFuelUserSettingTypes = {
  ...
  /** The calculated ramp weight, in pounds. A negative value indicates the weight could not be calculated. */
  weightFuelRamp: number;

  /** The calculated takeoff weight, in pounds. A negative value indicates the weight could not be calculated. */
  weightFuelTakeoff: number;
}
