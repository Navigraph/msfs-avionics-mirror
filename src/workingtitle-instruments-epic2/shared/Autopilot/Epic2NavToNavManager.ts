import {
  ApproachProcedure, ApproachUtils, APValues, BitFlags, CdiDeviation, ClockEvents, ConsumerValue, EventBus, FacilityLoader, GeoPoint, Localizer, NavComEvents,
  NavEvents, NavMath, NavRadioEvents, NavSourceId, NavSourceType, NavToNavManager, ObsSetting, SimVarValueType, Subject, Subscribable, Subscription, VorFacility
 ...
 */
export class Epic2NavToNavManager implements NavToNavManager {
  ...
  /** @inheritdoc */
  public canLocArm = (): boolean => { return this.canArm(); };
