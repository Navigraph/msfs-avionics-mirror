...
import {
  AdcEvents, AltitudeSelectManager, AltitudeSelectManagerOptions, APAltitudeModes, APConfig, APEvents, APLateralModes, APVerticalModes, Autopilot,
...
export class Epic2Autopilot extends Autopilot {
  ...
  protected override initVerticalModes(): void {
    ...
    if (this.directors.gaVerticalDirector) {
      const oldOnActivate = this.directors.gaVerticalDirector.onActivate;
