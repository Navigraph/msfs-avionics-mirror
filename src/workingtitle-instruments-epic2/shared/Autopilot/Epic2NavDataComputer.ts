import {
  ...
  FlightPlanUtils, GeoCircle, GeoPoint, GeoPointInterface, GNSSEvents, LegDefinition, LegDefinitionFlags, LegType, LNavDataVars, LNavEvents, LNavTransitionMode,
  LNavUtils, MagVar, NavEvents, ObjectSubject, SimVarValueType, UnitType
...
import { Epic2LNavDataEvents, Epic2LNavDataVars } from '../Navigation/Epic2LNavDataEvents';
...
export class Epic2NavDataComputer {
  ...
  constructor(
    ...
    this.lnavData.sub((obj, key, value) => {
      switch (key) {
        ...
        case 'nominalLegIndex': SimVar.SetSimVarValue(Epic2LNavDataVars.NominalLegIndex, SimVarValueType.Number, value); break;
        case 'destinationDistanceDirect': SimVar.SetSimVarValue(Epic2LNavDataVars.DestinationDistanceDirect, SimVarValueType.NM, value); break;
        case 'distanceToFaf': SimVar.SetSimVarValue(Epic2LNavDataVars.FafDistance, SimVarValueType.NM, value); break;
        case 'isHolding': SimVar.SetSimVarValue(Epic2LNavDataVars.IsHolding, SimVarValueType.Bool, value); break;
      }
    }, true);
  }
  ...
  private computeTrackingVars(magVar: number): void {
    ...
    this.lnavData.set('isHolding', isHolding);
  }
  ...
  private updateCDIScaling(): void {
    ...
    this.lnavData.set('cdiScale', cdiScale);
  }
