...
ImageCache.addToCache('DOT', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/dot.png');
ImageCache.addToCache('AIRPORT_DOT', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/airport_dot.png');
ImageCache.addToCache('AIRPORT', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/airport.png');
ImageCache.addToCache('INTERSECTION', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/intersection.png');
ImageCache.addToCache('NDB', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/ndb.png');
ImageCache.addToCache('VOR', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/vor.png');
ImageCache.addToCache('DME', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/dme.png');
ImageCache.addToCache('VORDME', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/vordme.png');
ImageCache.addToCache('VORTAC', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/vortac.png');
ImageCache.addToCache('TACAN', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/tacan.png');
ImageCache.addToCache('FLIGHTPLAN', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/flightplan.png');
ImageCache.addToCache('FLIGHTPLAN_M', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/flightplan_m.png');
ImageCache.addToCache('FLIGHTPLAN_G', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/flightplan_g.png');
ImageCache.addToCache('FLIGHTPLAN_C', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/flightplan_c.png');
ImageCache.addToCache('FLIGHTPLAN_CIRCLE_WHITE', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/flightplan_circle_white.png');
ImageCache.addToCache('FLIGHTPLAN_CIRCLE_MAGENTA', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/flightplan_circle_magenta.png');
ImageCache.addToCache('FLIGHTPLAN_CIRCLE_GREEN', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/flightplan_circle_green.png');
ImageCache.addToCache('FLIGHTPLAN_CIRCLE_CYAN', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/flightplan_circle_green.png');
ImageCache.addToCache('TOD', 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/tod.png');
  ...
  public readonly withAirplaneIcon = (
    ...
    builder = builder
      ...
      .withLayer<MapOwnAirplaneLayer, MapOwnAirplaneLayerModules>(EpicMapKeys.OwnShipTriLayer, (context): VNode => {
        ...
        imageFilePath.set('coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/pc12-airplane-map.png');
        iconSize.set(50);
