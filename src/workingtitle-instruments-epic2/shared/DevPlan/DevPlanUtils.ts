import {
  AirportFacility, AirwayObject, ApproachTransition, EnrouteTransition, Facility, FacilitySearchType, FacilityType, GeoPoint, ICAO, IntersectionFacility,
...
export class DevPlanUtils {
   ...
   */
  public static async getAirwayFromLeg(fms: Epic2Fms, entryIdent: string, airwayName: string): Promise<AirwayObject> {
