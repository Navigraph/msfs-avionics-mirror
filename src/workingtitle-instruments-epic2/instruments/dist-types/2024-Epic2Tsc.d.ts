...
import { EventBus, FsInstrument, InstrumentBackplane, HEventPublisher, NavComSimVarPublisher, ElectricalPublisher, XPDRInstrument, AvionicsSystem, Subject, ComSpacing, DisplayComponent, ComponentProps, XPDRSimVarEvents, VNode, Subscription, Subscribable, NodeReference, NavComEvents, MutableSubscribable, SubscribableSet, ToggleableClassNameRecord, SetSubject, MappedSubject, SubscribableType } from '@microsoft/msfs-sdk';
import { AvionicsConfig, Epic2InputControlPublisher, NavComUserSettingManager, Tab, TabContentProps, TabContent, Epic2CockpitEvents, DisplayUnitIndices, TouchButton, TouchButtonProps, Epic2KeyboardControlHEvents, Epic2KeyboardCharHEvents, AdfSystemEvents, XpdrSystemEvents } from '@microsoft/msfs-epic2-shared';
...
/** TSC Window Tabs, */
type TscWindowTabs = 'home' | 'duandccd' | 'com' | 'nav' | 'xpdr' | 'tawsPage' | 'gpwsInhibitPage';
...
/** TSC Window Props */
interface TscWindowProps extends ComponentProps {
    /** An instance of the event bus. */
    bus: EventBus;
    /** TSC Service. */
    tscService: TscService;
...
declare class TscWindow extends DisplayComponent<TscWindowProps> {
    /** @inheritdoc  */
    render(): VNode | null;
}
...
declare class TscWindowMenu extends DisplayComponent<TscWindowMenuProps> {
    ...
    onAfterRender(): void;
    /** @inheritdoc */
    private setActiveAndLastViewedTab;
    /** @inheritdoc */
    private renderTab;
    /** @inheritdoc */
    render(): VNode;
...
/** A class containing getter functions for the TSC icons */
declare class TscIcons {
    /**
     * Gets a checklist icon for the TSC
     * @returns An SVG VNode containing the checklist icon
     */
    static getChecklistIcon(): VNode;
    /**
     * Gets a com icon for the TSC
     * @returns An SVG VNode containing the com icon
     */
    static getComIcon(): VNode;
    /**
     * Gets a datalink icon for the TSC
     * @returns An SVG VNode containing the datalink icon
     */
    static getDatalinkIcon(): VNode;
    /**
     * Gets a direct to icon for the TSC
     * @returns An SVG VNode containing the DTO icon
     */
    static getDirectToIcon(): VNode;
    /**
     * Gets a DU and CCD icon for the TSC
     * @returns An SVG VNode containing the DU and CCD icon
     */
    static getDuCcdIcon(): VNode;
    /**
     * Gets a home icon for the TSC
     * @returns An SVG VNode containing the home icon
     */
    static getHomeIcon(): VNode;
    /**
     * Gets an inhibit icon for the TSC
     * @param colour The colour this icon should have
     * @returns An SVG VNode containing the inhibit icon
     */
    static getInhibitIcon(colour: Subscribable<string>): VNode;
    /**
     * Gets an MFD format icon for the TSC
     * @returns An SVG VNode containing the MFD format icon
     */
    static getMfdFormatIcon(): VNode;
    /**
     * Gets a nav  icon for the TSC
     * @returns An SVG VNode containing the nav icon
     */
    static getNavIcon(): VNode;
    /**
     * Gets a setting icon for the TSC
     * @returns An SVG VNode containing the settings icon
     */
    static getSettingsIcon(): VNode;
    /**
     * Gets a show info icon for the TSC
     * @returns An SVG VNode containing the show info icon
     */
    static getShowInfoIcon(): VNode;
    /**
     * Gets a timer icon for the TSC
     * @returns An SVG VNode containing the show info icon
     */
    static getTimerIcon(): VNode;
    /**
     * Gets a WX, LX and TAWS icon for the TSC
     * @returns An SVG VNode containing the WX, LX and TAWS icon
     */
    static getWxLxTawsIcon(): VNode;
    /**
     * Gets a xpdr icon for the TSC
     * @returns An SVG VNode containing the xpdr icon
     */
    static getXpdrIcon(): VNode;
}
...
declare class XIcon extends DisplayComponent<XIconProps> {
    /** @inheritdoc */
    render(): VNode | null;
}
...
declare class KeyboardHEventPublisher {
    /**
     * Sends a key press to the DUs.
     * @param key The H event without H: prefix.
     */
    static sendKey(key: Epic2KeyboardCharHEvents | Epic2KeyboardControlHEvents): void;
}
...
declare class HomeTabContent extends DisplayComponent<HomeTabContentProps> {
    ...
    private readonly subscriber;
    private readonly publisher;
    private readonly gpwsControlSub;
    private readonly terrInhibitActive;
    private readonly gsInhibitActive;
    private readonly flapOverrideActive;
    private readonly areInhibitsActive;
    private subs;
    /** Home Button Info */
...
/** The Home Tab Content. */
declare class TawsWxLightningContainer extends TabContent<TawsWxLightningContainerProps> {
    private readonly rootRef;
...
export { BottomRow, CharInput, CharInputSlot, ComTabContent, CursorInput, DividerLine, DuAndCcdIcon, DuAndCcdSelectManager, DuAndCcdTabContent, Epic2TscController, Epic2TscInstrument, GenericCursorInputSlot, HomeTabContent, Keyboard, KeyboardAlphaKeyPopup, KeyboardController, KeyboardHEventPublisher, MenuTab, NavTabContent, NumberPad, RadioSub, TawsWxLightningContainer, TscButton, TscIconButton, TscIcons, TscService, TscSvgs, TscTabContent, TscWindow, TscWindowMenu, XIcon, XpdrTabContent };
export type { BottomRowProps, CharInputProps, CharInputSlotProps, CursorInputCharSelectionMode, CursorInputProps, CursorInputSlot, GenericCursorInputSlotProps, KeyValueMapType, KeyValues, KeyboardProps, NavButtonConfigProps, NavTabContentProps, NumButtonProps, RadioSubProps, TscButtonStyles, TscTabContentProps, TscWindowProps, TscWindowTabs };
