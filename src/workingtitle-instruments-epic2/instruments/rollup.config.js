...
const proj_key = 'epic2';
const inst_name = 'Epic2';
const inst_folder = `workingtitle-instruments-${proj_key}`;
const inst_path = `${inst_folder}/html_ui/Pages/VCockpit/Instruments/NavSystems/${inst_name}`;
