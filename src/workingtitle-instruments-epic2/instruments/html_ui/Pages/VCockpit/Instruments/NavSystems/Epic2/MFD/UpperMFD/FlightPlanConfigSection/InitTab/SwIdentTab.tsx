...
import { CockpitUserSettings, InputField, TabContent, TextInputFormat } from '@microsoft/msfs-epic2-shared';
  ...
  public render(): VNode {
    return (
      <div class="fpln-sw-ident-tab">
        ...
        <div class="fms-column">FMS:<span class="fms-text">WT0.1.2</span></div>
