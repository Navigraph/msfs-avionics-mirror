  ...
  private static getWaypointImage(facility: Facility): string {
    ...
    switch (ICAO.getFacilityType(facility.icao)) {
      case FacilityType.Airport:
        return 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/airport_w.png';
      case FacilityType.Intersection:
        return 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/intersection.png';
      case FacilityType.VOR: {
        switch ((facility as VorFacility).type) {
          case VorType.DME:
            return 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/dme.png';
          case VorType.VORTAC:
            return 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/vortac.png';
          case VorType.VORDME:
            return 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/vordme.png';
          case VorType.ILS:
            return 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/localizer.png';
          default:
            return 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/vor.png';
        }
      }
      case FacilityType.NDB:
        return 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/ndb.png';
      default:
        return 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/Epic2/Assets/Icons/flightplan.png';
    }
    ...
    return (
      <div class='select-object-modal-label'>
        <p>
          ...
          {ICAO.getIdent(facility.icao).padEnd(7, '\xa0')}&nbsp;{city}
        </p>
        <p>{name}</p>
        ...
        <div class="waypoint-list-container">
          <div class="waypoint-list-placeholder">
            ...
            <Epic2List<any>
              ...
              sortItems={(a, b) => {
                const ppos = this.props.fms.ppos;
                return isFinite(ppos.lat) && isFinite(ppos.lon) ? (ppos.distance(a.lat, a.lon) - ppos.distance(b.lat, b.lon)) : 0;
              }}
