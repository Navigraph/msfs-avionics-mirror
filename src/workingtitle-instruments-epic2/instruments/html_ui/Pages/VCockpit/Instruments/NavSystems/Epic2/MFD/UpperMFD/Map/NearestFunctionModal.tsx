import {
  AirportFacility, ArraySubject, ClockEvents, ConsumerSubject, EventBus, FacilityType, FlightPlan, FSComponent, GeoPoint, GNSSEvents, ICAO, LegType,
  NearestContext, SetSubject, Subject, SubscribableArrayEventType, UnitType, VNode
          ...
          <div class="airport-list-placeholder">
            ...
            <Epic2List<any>
              ...
              renderItem={(data: AirportFacility) => {
                ...
                const longestRunway = data.runways.sort((a, b) => b.length - a.length)[0];
                const elevation = UnitType.FOOT.convertFrom(longestRunway.elevation, UnitType.METER).toFixed(0);
                const length = UnitType.FOOT.convertFrom(longestRunway.length, UnitType.METER).toFixed(0);
